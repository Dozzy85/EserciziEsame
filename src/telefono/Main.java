...
Consigli:
S’invita a porre particolare attenzione al metodo chiamata(double minutiDurata),
che aggiorna il credito e incrementa di una unità il numeroChiamate.*/

public class Main {

	public static void main(String[] args) {

		Cellulare cel=new Cellulare(10, 0);
		cel.chiama(2);
		cel.ricarica(5);
		System.out.println("Credito residuo: "+cel.numero404());
		System.out.println("Numero chiamate: "+cel.getNumeroChiamate());
		cel.chiama(3);
		System.out.println("Numero chiamate: "+cel.getNumeroChiamate());
		cel.azzeraChiamate();
		System.out.println("Numero chiamate: "+cel.getNumeroChiamate());
